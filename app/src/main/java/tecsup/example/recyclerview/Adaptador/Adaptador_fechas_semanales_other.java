...
public class Adaptador_fechas_semanales_other  extends RecyclerView.Adapter<Adaptador_fechas_semanales_other.Entidad> {

    private List<Datos_Semanales> datos3;
    public Context context;

    public Adaptador_fechas_semanales_other(List<Datos_Semanales> datos3, Context context) {
        this.datos3 = datos3;
    ...
    @Override
    @NonNull
    public Adaptador_fechas_semanales_other.Entidad onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lista_fecha_semanal_other, parent, false);
        return new Adaptador_fechas_semanales_other.Entidad(view);
    }

    @Override
    public void onBindViewHolder(final Adaptador_fechas_semanales_other.Entidad holder, int i) {
    ...
    public class Entidad extends RecyclerView.ViewHolder {
        ...
        public Entidad(View itemView) {
            super(itemView);
            contenido1 = itemView.findViewById(R.id.contenido_fecha1_other);
            contenido2 = itemView.findViewById(R.id.contenido_fecha2_other);
            contenido3 = itemView.findViewById(R.id.contenido_fecha3_other);
            contenido4 = itemView.findViewById(R.id.contenido_fecha4_other);
            contenido5 = itemView.findViewById(R.id.contenido_fecha5_other);
            contenido6 = itemView.findViewById(R.id.contenido_fecha6_other);
            contenido7 = itemView.findViewById(R.id.contenido_fecha7_other);
